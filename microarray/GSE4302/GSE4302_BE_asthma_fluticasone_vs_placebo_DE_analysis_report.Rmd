---
title: 'Microarray Data Analysis -- GSE4302 fluticasone vs placebo'
...
geo_id="GSE4302"
# phenotype file
pheno_fn="C:/Users/mengykan/Projects/AsthmaApp/res/microarray/GSE4302_BE_asthma_fluticasone_vs_placebo.txt"
...
```{r eval=T}
if (comptype=="Treatment"&nlevels(as.factor(rma.data.of.interest$Subject))<=10) {
  df <- data.frame(
    PC1=pc$PC1,
    PC2=pc$PC2,
    group=as.factor(rma.data.of.interest$Subject)
  )
  colour_subject <- colours[1:nlevels(as.factor(rma.data.of.interest$Subject))]
