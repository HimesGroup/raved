---
title: 'Quality Control for Gene Expression Microarray Data -- GSE55877'
...
pheno.new <- pheno.df %>%
  ...
  dplyr::mutate(Treatment=ifelse(grepl("DEX",title),"dex",ifelse(grepl("PRED",title),"pred","baseline"))) %>%
  dplyr::mutate(Treatment_des=ifelse(grepl("DEX",title),"Dex 100nM 6h",ifelse(grepl("PRED",title),"Pred 100nM 6h",NA))) %>%
